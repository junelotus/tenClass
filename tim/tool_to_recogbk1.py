...
def pregetTimeresultOrDelay(img_color, imageModel, flag_of_path=0, kind='timeresult',listsOfImg_position=[], detectrou_tool=None):
    ...
    if len(listsOfImg_position) == 0:
        ...
        detectrou_tool.set_path_or_image(img_color, '/Users/xhj/opencv_bitbucket/timestampocr/model_8.jpg')
...
def half_of_video_deal(begin_frame_counter,end_frame_counter,path):
    ...
    imageModel, contours_model_result = getModelJEPGAnd15Positions("/Users/xhj/opencv_bitbucket/timestampocr/model_8.jpg")
...
def main_to_call(path,begin_frame,end_frame):
...
frame_counter = int(cap.get(cv2.CAP_PROP_FRAME_COUNT))
cap.release()    
main_to_call(path,0,frame_counter-1)
'''
    dealy_ms=[0.0,0.0,0.0]
