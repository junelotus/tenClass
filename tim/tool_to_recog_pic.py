...
def binary_find_the_same_frame(first_reserve,current_frame,flag = 'headortail',listsOfImg_position=[],pre_time= -1):
    begin = 0
    ...
    while begin+1 < end:
        ...
        if flag == 'tail':
            if abs(pre_time-first_reserve[middle][0]) < 200:
                return first_reserve,-1
        now_image = first_reserve[middle][1]
        listsOfImg, listsOfImg_position = pregetTimeresultOrDelay(now_image, imageModel, flag_of_path,listsOfImg_position,detectrou_tool=detectrou_tool)
        now_image, thIfDelay = getDelayResultImage(listsOfImg, contours_model_result[0])
...
if __name__ == '__main__':
    ...
    path_of_all = glob.glob('/Users/xhj/Downloads/720_jpg/*.jpg')
    path_of_all.sort()
    print('path_of_all',path_of_all)
    counter_all = 0
    ...
    #         break
        ...
        showImg('current_frame',current_frame)
        # 记录下之前的帧
        ...
        if len(first_reserve) == 0 or end_time-first_reserve[0][0] < 200:
            ...
            if False == loss3:
                # print('不同')
                # if find_head_of_first_reserve == True:
                # find_head_of_first_reserve = False
                # print('first')
                first_reserve,time_now = binary_find_the_same_frame(first_reserve, pre_image,flag='tail',listsOfImg_position=listsOfImg_position,pre_time=pre_time)
                ...
                # print('second')
                first_reserve,time_now = binary_find_the_same_frame(first_reserve,currentImage,flag='head',listsOfImg_position=listsOfImg_position)
